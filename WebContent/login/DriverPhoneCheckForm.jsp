...
<script>
	...
	function pValue(){
        document.getElementById("firstPhone").value = opener.document.driverEnrollForm.firstPhone.value;
        document.getElementById("secondPhone").value = opener.document.driverEnrollForm.secondPhone.value;
        document.getElementById("thirdPhone").value = opener.document.driverEnrollForm.thirdPhone.value;
    }
    ...
    function sendCheckValue(){
        ...
        opener.document.driverEnrollForm.firstPhone.value = document.getElementById("firstPhone").value;
        opener.document.driverEnrollForm.secondPhone.value = document.getElementById("secondPhone").value;
        opener.document.driverEnrollForm.thirdPhone.value = document.getElementById("thirdPhone").value;

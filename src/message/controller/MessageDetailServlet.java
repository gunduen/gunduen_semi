...
public class MessageDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if( message != null) {
			request.setAttribute("detail", message);
			RequestDispatcher view = request.getRequestDispatcher("/message/messageDetail.jsp");
			view.forward(request, response);
		} else {
			request.getRequestDispatcher("/message/sendError.html").forward(request, response);
		}
	}
